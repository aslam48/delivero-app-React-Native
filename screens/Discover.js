            ...
            {mainData?.length > 0 ? (
              <>
                <ItemCardContainer
                  key={"102"}
                  imageSrc={
                    "https://images.unsplash.com/photo-1661961110671-77b71b929d52?ixlib=rb-4.0.3&ixid=MnwxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwxfHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=400&q=60"
                  }
                  title=""
                  location=""
                />
                <ItemCardContainer
                  key={"101"}
                  imageSrc={
                    "https://images.unsplash.com/photo-1661961110372-8a7682543120?ixlib=rb-4.0.3&ixid=MnwxMjA3fDF8MHxlZGl0b3JpYWwtZmVlZHwyMXx8fGVufDB8fHx8&auto=format&fit=crop&w=400&q=60"
                  }
                  title=""
                  location=""
                />
